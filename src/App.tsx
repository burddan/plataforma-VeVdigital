...
import { Whatsapp1 } from "./components/Whatsapp1";
...
export default function App() {
		...
		return (
				...
				{currentScreen === "profile" && <Perfil userName={userName} userAvatar={userAvatar} userGender={userGender as 'masculino' | 'feminino'} userBirthdate={userBirthdate} unlockedAchievements={unlockedAchievements} onBack={handleBackToDashboard} />}
				{currentScreen === "whatsappLesson" && <Whatsapp1 onComplete={handleLessonComplete} onBack={handleBackToDashboard} />}
				{currentScreen === "whatsappLesson2" && <Whatsapp2 onComplete={handleLesson2Complete} onBack={handleBackToDashboard} />}
				{currentScreen === "whatsappLesson3" && <Whatsapp3 onComplete={handleLesson3Complete} onBack={handleBackToDashboard} />}
				{currentScreen === "youtubeLesson1" && <Youtube1 onComplete={handleYouTubeLesson1Complete} onBack={handleBackToDashboard} />}
				{currentScreen === "youtubeLesson2" && <Youtube2 onComplete={handleYouTubeLesson2Complete} onBack={handleBackToDashboard} />}
				{currentScreen === "youtubeLesson3" && <Youtube3 onComplete={handleYouTubeLesson3Complete} onBack={handleBackToDashboard} />}
				{currentScreen === "instagramLesson1" && <Instagram1 onComplete={handleInstagramLesson1Complete} onBack={handleBackToDashboard} />}
				</div>
				</div>
		);
}
